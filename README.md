...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3b26og4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3b26og4.containers.anotherwebservice.com/
...
```
git clone git@github.com:francisamidu/container-3b26og4.git
cd container-3b26og4
```
...
```
docker attach container-3b26og4
```
